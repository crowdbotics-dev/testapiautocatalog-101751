...
## Project Structure
    ...
    ├── testapiautocatalog_101751  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_101751`
...
2. Clone this repo and `cd testapiautocatalog_101751`
